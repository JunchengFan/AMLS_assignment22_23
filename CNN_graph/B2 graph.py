...
model = load_model('/Users/fanjuncheng/Desktop/code/B1/save_model/model.h5')
...
# Read the image you want to extract features from
    image = cv2.imread('/Users/fanjuncheng/Desktop/dataset_AMLS_22-23/cartoon_set/img/0.png')
