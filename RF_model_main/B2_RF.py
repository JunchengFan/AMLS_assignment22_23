...
with open ('/Users/fanjuncheng/Desktop/dataset_AMLS_22-23/cartoon_set/labels.csv') as f:
    ...
    for line in f:
        ...
        images.append(image)
        if int(label1) == 0:
            labels.append(0) #eye colour 0
        elif int(label1) == 1:
            labels.append(1) # eye colour 1
        elif int(label1) == 2:
            labels.append(2) #eye colour 2
        elif int(label1) == 3:
            labels.append(3) #eye colour 3
        elif int(label1) == 4:
            labels.append(4) #eye colour 4
        #print(name, labels)
...
plt.xlabel("B2 Feature Index")
plt.ylabel("B2 Feature Importance")
plt.show()
...
img.save('B2_graph_high_resolution_newest.png', dpi=(300, 300))
